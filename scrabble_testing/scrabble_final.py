# AUTHOR - Brandon Herren, 7/22/2018
...
# Read-in board
board = []
with open(local_path + 'resources\\test_board.csv', 'r') as csvfile:
	board_reader = csv.reader(csvfile)
	for row in board_reader:
		board.append(row)

letters = ['E', 'O', 'D', 'L', 'R', 'O', 'A']
...
def find_all_moves(hand, board_col, board_row, possibilities_by_length):
									...
									if (word_location not in row_words):
										...
										if (side_okay):
											...
											if (score > highest_score):
												...
												highest_score = score
												highest_score_move_orientation = label
	...
	if (total_tiles_used > 70):
		print("Move chosen: " + highest_score_move + ", " + highest_score_move_orientation)
	else:
		print("Move chosen: " + best_move + ", " + best_move_orientation)
